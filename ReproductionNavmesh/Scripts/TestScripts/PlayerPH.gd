...
#Adapted from Bob's Quest and blocked out, need to recode
...
#var player_is_controllable
#var camera_style
# 0 = player, 1 = motorbike // or just use playerdata. playeraiming 

onready var cam_normal_pos = get_node("NormalCamPos")
onready var cam_car_pos = get_node("CarCamPos")

onready var rotation_target  = get_node("rotation_target")

#positions to set to on bones
onready var col_head_attach = get_node("ArmaturePlayer01/Skeleton/BoneAttachmentHead/AttachPoint")
onready var col_body_upper_attach = get_node("ArmaturePlayer01/Skeleton/BoneAttachmentBodyUpper/AttachPoint")
onready var col_body_lower_attach = get_node("ArmaturePlayer01/Skeleton/BoneAttachmentBodyLower/AttachPoint")
onready var col_pelvis_attach = get_node("ArmaturePlayer01/Skeleton/BoneAttachmentPelvis/AttachPoint")
onready var col_arm_left_upper_attach = get_node("ArmaturePlayer01/Skeleton/BoneAttachmentArmLeftUpper/AttachPoint")
onready var col_arm_left_lower_attach = get_node("ArmaturePlayer01/Skeleton/BoneAttachmentArmLeftLower/AttachPoint")
onready var col_arm_right_upper_attach = get_node("ArmaturePlayer01/Skeleton/BoneAttachmentArmRightUpper/AttachPoint")
onready var col_arm_right_lower_attach = get_node("ArmaturePlayer01/Skeleton/BoneAttachmentArmRightLower/AttachPoint")
onready var col_leg_left_upper_attach = get_node("ArmaturePlayer01/Skeleton/BoneAttachmentLegLeftUpper/AttachPoint")
onready var col_leg_left_lower_attach = get_node("ArmaturePlayer01/Skeleton/BoneAttachmentLegLeftLower/AttachPoint")
onready var col_leg_left_foot_attach = get_node("ArmaturePlayer01/Skeleton/BoneAttachmentLegLeftFoot/AttachPoint")
onready var col_leg_right_upper_attach = get_node("ArmaturePlayer01/Skeleton/BoneAttachmentLegRightUpper/AttachPoint")
onready var col_leg_right_lower_attach = get_node("ArmaturePlayer01/Skeleton/BoneAttachmentLegRightLower/AttachPoint")
onready var col_leg_right_foot_attach = get_node("ArmaturePlayer01/Skeleton/BoneAttachmentLegRightFoot/AttachPoint")

#collision shapes 
onready var col_shape_head = get_node("CollisionShapeHead")
onready var col_shape_body_upper = get_node("CollisionShapeBodyUpper")
onready var col_shape_body_lower = get_node("CollisionShapeBodyLower")
onready var col_shape_pelvis = get_node("CollisionShapePelvis")
onready var col_shape_arm_left_upper = get_node("CollisionShapeArmLeftUpper")
onready var col_shape_arm_left_lower = get_node("CollisionShapeArmLeftLower")
onready var col_shape_arm_right_upper = get_node("CollisionShapeArmRightUpper")
onready var col_shape_arm_right_lower = get_node("CollisionShapeArmRightLower")
onready var col_shape_leg_left_upper = get_node("CollisionShapeLegLeftUpper")
onready var col_shape_leg_left_lower = get_node("CollisionShapeLegLeftLower")
onready var col_shape_leg_left_foot = get_node("CollisionShapeLegLeftFoot")
onready var col_shape_leg_right_upper = get_node("CollisionShapeLegRightUpper")
onready var col_shape_leg_right_lower = get_node("CollisionShapeLegRightLower")
onready var col_shape_leg_right_foot = get_node("CollisionShapeLegRightFoot")

#onready var cam_holder = get_node("CamHolder")

func _ready():
	col_shape_head.global_transform = col_head_attach.global_transform
	col_shape_body_upper.global_transform = col_body_upper_attach.global_transform
	col_shape_body_lower.global_transform = col_body_lower_attach.global_transform
	col_shape_pelvis.global_transform = col_pelvis_attach.global_transform
	col_shape_arm_left_upper.global_transform = col_arm_left_upper_attach.global_transform
	col_shape_arm_left_lower.global_transform = col_arm_left_lower_attach.global_transform
	col_shape_arm_right_upper.global_transform = col_arm_right_upper_attach.global_transform
	col_shape_arm_right_lower.global_transform = col_arm_right_lower_attach.global_transform
	col_shape_leg_left_upper.global_transform = col_leg_left_upper_attach.global_transform
	col_shape_leg_left_lower.global_transform = col_leg_left_lower_attach.global_transform
	col_shape_leg_left_foot.global_transform = col_leg_left_foot_attach.global_transform
	col_shape_leg_right_upper.global_transform = col_leg_right_upper_attach.global_transform
	col_shape_leg_right_lower.global_transform = col_leg_right_lower_attach.global_transform
	col_shape_leg_right_foot.global_transform = col_leg_right_foot_attach.global_transform
	
	PlayerData.Player_Information.player_name = "Bob"
...
#	shield_right_point=$ArmaturePlayer01/Skeleton/RShieldAttach/ShieldAttachR
	...
	#cam_pitch = $CamHolder/CamRotY/CamRotX.get_rotation().x
	cam_pitch = $rotation_target/target/Camera._total_pitch
	cam_yaw = $rotation_target/target/Camera._total_yaw
	
#	cam_pitch = get_parent().get_node("Camera")._total_pitch
#	cam_yaw = get_parent().get_node("Camera")._total_yaw
...
#		inventory_node.update_slot6_amount()
	...
	if PlayerData.player_is_controllable == true:
...
#	cam_yaw = get_parent().get_node("Camera")._total_yaw
	...
	if PlayerData.player_is_in_vehicle == 0:
		rotation_target.global_transform.origin.x = cam_normal_pos.global_transform.origin.x
		rotation_target.global_transform.origin.z = cam_normal_pos.global_transform.origin.z
		rotation_target.global_transform.origin.y = cam_normal_pos.global_transform.origin.y
	elif PlayerData.player_is_in_vehicle == 1:
		rotation_target.global_transform.origin.x = cam_car_pos.global_transform.origin.x
		rotation_target.global_transform.origin.z = cam_car_pos.global_transform.origin.z
		rotation_target.global_transform.origin.y = cam_car_pos.global_transform.origin.y
...
func _physics_process(delta):
	...
	#		UI_Status_Label_06.text = "   " + str(attack_timer)
		...
		#animation stuff needs setting up
		if is_on_floor():
...
#			get_node("AnimationTreePlayer").oneshot_node_start("AttackOneShot")
	...
	elif PlayerData.player_is_controllable == false:
		if PlayerData.player_is_in_vehicle == 1:
			anim = ANIM_SEATED
		elif PlayerData.player_is_in_vehicle == 2:
			anim = ANIM_BIKE
		elif PlayerData.player_is_in_vehicle == 3:
			anim = ANIM_SEATED
...
#		shield_value = 0
	...
	damage_to_player = damage_received#(damage_received - armour_value - shield_value - fort_mod)
...
func set_player_rotation(x,y,z):
	var player_face_up = Vector3(x, y, z)
	character.set_rotation(player_face_up)
